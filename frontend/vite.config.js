...
export default defineConfig({
    ...
    server: {
        host: true,
        // Puerto fijo distinto de 5173: en esta laptop 5173 lo ocupa
        // permanentemente el backend de Docker Desktop / WSL relay, y sin
        // strictPort Vite salta a otro puerto en silencio (rompe la regla
        // de firewall y la URL que se comparte para pruebas en red).
        port: 5180,
        strictPort: true,
        headers: {
