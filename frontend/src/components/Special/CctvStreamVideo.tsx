...
interface CctvStreamVideoProps {
    streamUrl?: string;
    className?: string;
    muted?: boolean;
    /** opcional: ref al nodo video (p. ej. captura a lienzo). */
    captureVideoRef?: React.MutableRefObject<HTMLVideoElement | null>;
    /** fotograma listo (loadeddata / canplay). */
    onVideoReady?: () => void;
}
 ...
 */
function CctvStreamVideo({ streamUrl, className, muted = true, captureVideoRef, onVideoReady }: CctvStreamVideoProps) {
...
export default memo(CctvStreamVideo);
