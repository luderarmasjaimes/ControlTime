...
interface MapCaptureModalProps {
  onClose: () => void;
  onCaptureComplete: (imageDataUrl: string) => void;
  companyName?: string;
}

const MapCaptureModal = ({ onClose, onCaptureComplete, companyName }: MapCaptureModalProps) => {
  ...
  const handleCaptureMap = (imageDataUrl: string) => {
...
export default memo(MapCaptureModal);
