...
// "Cambio de perfil" lo ejecuta un admin sobre OTRO usuario -- debe ofrecer
// los 7 roles reales, incluido 'viewer'.
...
function UserMaintenanceModal({ onClose }: UserMaintenanceModalProps) {
...
export default memo(UserMaintenanceModal);
