...
interface DeleteReportConfirmProps {
  report: { id: string; title?: string };
  onClose: () => void;
  onSuccess?: (message: string) => void;
}

function DeleteReportConfirm({ report, onClose, onSuccess }: DeleteReportConfirmProps) {
...
export default memo(DeleteReportConfirm);
