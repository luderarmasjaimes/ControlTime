    ...
    >
      ...
      <div className="toolbox-section panel-library-tools">
        ...
        <div className="toolbox-grid">
          ...
          <button type="button" className="tool-action" onClick={onAddHeader} title="Insertar encabezado (cabecera) en la página">
            <Heading size={18} aria-hidden />
            {isExpanded && <span className="tool-action-label">Encabezado</span>}
          </button>
          <button type="button" className="tool-action" onClick={onAddFooter} title="Insertar pie de página en la página">
            <PanelBottom size={18} aria-hidden />
            {isExpanded && <span className="tool-action-label">Pie de página</span>}
          </button>
