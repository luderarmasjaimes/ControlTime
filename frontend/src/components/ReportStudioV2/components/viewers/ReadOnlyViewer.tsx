...
function ReadOnlyElement({ element, pageNumber, totalPages, hideOverlayText }: { element: any; pageNumber?: number; totalPages?: number; hideOverlayText?: boolean }) {
  ...
  if (element.type === 'text') {
    ...
    const _segments = buildStyledSegments(_textContent, _spans, _base);
