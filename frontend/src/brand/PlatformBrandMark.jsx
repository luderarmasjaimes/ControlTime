...
export function PlatformBrandAuthStrip({ suiteLine = PLATFORM_ACCESS_LINE }) {
    return (
...
export function PlatformBrandCameraBadge({ size = 36 }) {
    return (
        <img
            src={PLATFORM_LOGO_SRC}
            alt=""
 ...
 */
export function PlatformBrandDashboardBlock({ linePrimary, lineSecondary }) {
...
export function PlatformBrandToolbarBlock({ titleLine, subtitleLine }) {
