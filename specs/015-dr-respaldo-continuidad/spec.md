...
> Trazabilidad automática desde [`specs/REGISTRY.md`](../REGISTRY.md) para **SPEC-015**; fuente ADR: `docs/decisions/`.
...
- **ADR-059** — [`059-plan-maestro-pruebas-qa.md`](../../docs/decisions/059-plan-maestro-pruebas-qa.md)
