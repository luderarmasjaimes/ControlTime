...
**Ámbito `ia`: 40 filas reales en esta tabla al 2026-09-11 (recontadas por grep de filas `| NNN |` — última corrección directa del conteo, reemplaza el "22"/"29"/"35" de notas anteriores del 2026-09-10/11). Desglose no recalculado fila por fila en esta pasada; ver cada fila individual para status exacto.**
